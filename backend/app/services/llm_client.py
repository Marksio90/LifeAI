...
client = OpenAI(api_key=os.getenv("OPENAI_API_KEY"))  # Synchronous client
aclient = AsyncOpenAI(api_key=os.getenv("OPENAI_API_KEY"))  # Async client
...
def call_llm_sync(
    ...
    **kwargs
    ...
    try:
        ...
        logger.error(f"Error calling LLM (sync): {e}")
        raise
